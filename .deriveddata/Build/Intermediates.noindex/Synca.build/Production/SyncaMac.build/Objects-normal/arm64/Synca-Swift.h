...
#ifndef SYNCA_SWIFT_H
#define SYNCA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Synca",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC5Synca11AuthService")
@interface AuthService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASAuthorizationController;
@interface AuthService (SWIFT_EXTENSION(Synca)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface AuthService (SWIFT_EXTENSION(Synca)) <ASAuthorizationControllerDelegate>
...
@interface Coordinator (SWIFT_EXTENSION(Synca)) <ASAuthorizationControllerPresentationContextProviding>
- (ASPresentationAnchor _Nonnull)presentationAnchorForAuthorizationController:(ASAuthorizationController * _Nonnull)controller SWIFT_WARN_UNUSED_RESULT;
@end

@interface Coordinator (SWIFT_EXTENSION(Synca)) <ASAuthorizationControllerDelegate>
- (void)authorizationController:(ASAuthorizationController * _Nonnull)controller didCompleteWithAuthorization:(ASAuthorization * _Nonnull)authorization;
- (void)authorizationController:(ASAuthorizationController * _Nonnull)controller didCompleteWithError:(NSError * _Nonnull)error;
@end
...
@class NSData;
@class NSString;
SWIFT_CLASS("_TtC5Synca14MacAppDelegate")
...
SWIFT_CLASS("_TtC5Synca23MacNotificationDelegate")
...
@class NSWindow;
SWIFT_CLASS("_TtC5Synca27MacWindowBehaviorController")
@interface MacWindowBehaviorController : NSObject <NSWindowDelegate>
- (BOOL)windowShouldClose:(NSWindow * _Nonnull)sender SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC5Synca21PasteAwareMacTextView")
@interface PasteAwareMacTextView : NSTextView
- (BOOL)performKeyEquivalent:(NSEvent * _Nonnull)event SWIFT_WARN_UNUSED_RESULT;
- (void)keyDown:(NSEvent * _Nonnull)event;
